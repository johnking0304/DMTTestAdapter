...
namespace TAI.Calibrator
{
    ...
    public class CalibrateCommand
    {
        ...
        private void SetADLHeader()
        {
            ...
            this.ADLHeader.Port = (ushort)this.Calibrator.UDPService.Port;

            byte[] ipAddress =new byte[4] { 0xc0, 0xa8, 0x01, 0x08 };
            Array.Copy(ipAddress, this.ADLHeader.IpAddress,4);
